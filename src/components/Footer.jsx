  ...
  return (
    <footer className="px-4 divide-y bg-gray-100 text-gray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-1/3">
          <Link
            ...
            to="/" // Update the 'to' prop with your home route
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          <div className="space-y-3">
            <h3 className="tracki uppercase text-gray-900">Features</h3>
            <ul className="space-y-1">
              {/* Use Link for navigation links */}
              <li>
                <Link to="/diet-tracking">Diet Tracking</Link>
              </li>
              <li>
                <Link to="/exercise-logs">Exercise Logs</Link>
              </li>
              <li>
          ...
          <div className="space-y-3">
            <h3 className="tracki uppercase text-gray-900">About</h3>
            <ul className="space-y-1">
              {/* Use Link for navigation links */}
              <li>
      ...
      <div className="py-6 text-sm text-center text-gray-600">
        © 2023 WellTrackr. All rights reserved.
      </div>
    </footer>
  );
};
